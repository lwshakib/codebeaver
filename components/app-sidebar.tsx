...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border bg-sidebar" {...props}>
      <SidebarHeader className="h-14 flex items-center border-b border-sidebar-border px-4 group-data-[collapsible=icon]:px-0">
        <SidebarMenu>
          <SidebarMenuItem className="w-full flex justify-center">
            <SidebarMenuButton size="lg" className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:w-10 group-data-[collapsible=icon]:mx-auto">
              <div className="flex items-center gap-3 w-full group-data-[collapsible=icon]:justify-center">
                <Icon icon="logos:github-icon" className="size-5 shrink-0 dark:invert" />
                <span className="font-semibold text-sidebar-foreground group-data-[collapsible=icon]:hidden">lwshakib</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      ...
      <SidebarFooter className="p-4 group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:py-4 flex flex-col gap-4">
        ...
        <div className="flex w-full items-center justify-start group-data-[collapsible=icon]:justify-center px-1">
          <SidebarTrigger className="size-8 rounded-md bg-transparent border-none text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground shrink-0">
